...
test("Expression valid case", () => {
  ...
  expect(new Expression([nmm("123.45")])).toStrictEqual(Expression.parseWith(cpb("123.45mm "), NumberUOL.parse));
  expect(new Expression([n("123"), o("+"), n("456")])).toStrictEqual(
    Expression.parseWith(cpb("123+456"), NumberUOL.parse)
  );
  expect(new Expression([n("123"), o("+"), n("456")])).toStrictEqual(
    Expression.parseWith(cpb("123 +456"), NumberUOL.parse)
  );
  ...
  expect(new Expression([nmm("123"), o("+"), n("-456")])).toStrictEqual(
    Expression.parseWith(cpb("123mm + -456"), NumberUOL.parse)
  );
  expect(new Expression([nmm("123"), o("+"), nmm("-456")])).toStrictEqual(
    Expression.parseWith(cpb("123mm + -456mm"), NumberUOL.parse)
  );
  expect(new Expression([n("123"), o("+"), nmm("-456")])).toStrictEqual(
    Expression.parseWith(cpb("123 + -456mm"), NumberUOL.parse)
  );
  expect(new Expression([n("123"), o("+"), n("456"), o("+"), n("789")])).toStrictEqual(
    Expression.parseWith(cpb("123+456+789"), NumberUOL.parse)
  );
  expect(new Expression([n("123"), o("+"), n("456"), o("+"), n("789")])).toStrictEqual(
    Expression.parseWith(cpb("123 +456 + 789"), NumberUOL.parse)
  );
  ...
  expect(new Expression([ob, ob, n("123"), cb, cb])).toStrictEqual(
    Expression.parseWith(cpb("((123))"), NumberUOL.parse)
  );
  expect(new Expression([ob, ob, n("123"), cb, cb])).toStrictEqual(
    Expression.parseWith(cpb("( (123 ))"), NumberUOL.parse)
  );
  ...
  expect(new Expression([ob, ob, n("123"), o("+"), n("456"), cb, cb])).toStrictEqual(
    Expression.parseWith(cpb(" ( ( 123+456 ) ) "), NumberUOL.parse)
  );
  expect(new Expression([ob, ob, n("123"), o("+"), n("456"), cb, cb])).toStrictEqual(
    Expression.parseWith(cpb(" ( ( 123 + 456 ) ) "), NumberUOL.parse)
  );
  expect(new Expression([ob, ob, n("123"), o("+"), ob, n("456"), o("-"), n("3"), cb, cb, cb])).toStrictEqual(
    Expression.parseWith(cpb(" ( ( 123 + (456-3) ) ) "), NumberUOL.parse)
  );
  expect(new Expression([ob, n("123"), o("+"), n("456"), cb, o("*"), n("789")])).toStrictEqual(
    Expression.parseWith(cpb("(123+456)*789"), NumberUOL.parse)
  );
  expect(new Expression([n("123"), o("*"), ob, n("789"), o("/"), n("3.14"), cb])).toStrictEqual(
    Expression.parseWith(cpb("123*(789/3.14)"), NumberUOL.parse)
  );
  expect(new Expression([ob, n("123"), cb, o("*"), ob, n("789"), o("/"), n("3.14"), cb])).toStrictEqual(
    Expression.parseWith(cpb("(123)*(789/3.14)"), NumberUOL.parse)
  );
  expect(
    new Expression([ob, n("123"), o("+"), n("456"), cb, o("*"), ob, n("789"), o("/"), n("3.14"), cb])
...
test("Computation valid case", () => {
  ...
  expect(c(c(n("123"), o("+"), n("456")), o("-"), n("789"))).toStrictEqual(
    Computation.parseWith(cpb("123+456-789"), NumberUOL.parse)
  );
  expect(c(n("123"), o("+"), c(n("456"), o("*"), n("789")))).toStrictEqual(
    Computation.parseWith(cpb("123+456*789"), NumberUOL.parse)
  );
  expect(c(c(n("123"), o("/"), n("456")), o("-"), n("789"))).toStrictEqual(
    Computation.parseWith(cpb("123/456-789"), NumberUOL.parse)
  );
  expect(c(c(c(n("1"), o("+"), n("2")), o("*"), n("3")), o("-"), n("4"))).toStrictEqual(
    Computation.parseWith(cpb("(1+2)*3-4"), NumberUOL.parse)
  );
  expect(c(c(n("1"), o("+"), n("2")), o("/"), c(n("3"), o("-"), n("4")))).toStrictEqual(
    Computation.parseWith(cpb("(1+2)/(3-4)"), NumberUOL.parse)
  );
  expect(c(n("1"), o("+"), c(n("2"), o("/"), c(n("3"), o("-"), n("4"))))).toStrictEqual(
    Computation.parseWith(cpb("1+2/(3-4)"), NumberUOL.parse)
  );
  expect(c(c(n("1"), o("+"), c(n("2"), o("/"), n("3"))), o("-"), n("4"))).toStrictEqual(
    Computation.parseWith(cpb("1+2/3-4"), NumberUOL.parse)
  );
  expect(c(n("1"), o("+"), c(n("2"), o("/"), c(n("3"), o("-"), c(n("4"), o("+"), n("5")))))).toStrictEqual(
    Computation.parseWith(cpb("1+2/(3-(4+5))"), NumberUOL.parse)
  );
  expect(c(n("1"), o("+"), c(n("2"), o("/"), c(c(n("3"), o("-"), n("4")), o("+"), n("5"))))).toStrictEqual(
    Computation.parseWith(cpb("1+2/((3-4)+5)"), NumberUOL.parse)
  );
  ...
  expect(Computation.parseWith(cpb("10mm+31.4mm"), NumberUOL.parse)?.compute(UnitOfLength.Centimeter)).toBeCloseTo(
    4.14
  );
  expect(Computation.parseWith(cpb("10mm+31.4mm"), NumberUOL.parse)?.compute(UnitOfLength.Meter)).toBeCloseTo(
    4.14 / 100
  );
  expect(Computation.parseWith(cpb("1m/100+31.4mm"), NumberUOL.parse)?.compute(UnitOfLength.Meter)).toBeCloseTo(
    4.14 / 100
  );
  expect(Computation.parseWith(cpb("1m/100+31.4mm"), NumberUOL.parse)?.compute(UnitOfLength.Centimeter)).toBeCloseTo(
    4.14
  );
  ...
  expect(Computation.parseWith(cpb("1+2/3-4"), NumberUOL.parse)?.compute(UnitOfLength.Centimeter)).toBeCloseTo(
    -2.33333
  );
  expect(Computation.parseWith(cpb("1+2/(3-(4+5))"), NumberUOL.parse)?.compute(UnitOfLength.Centimeter)).toBeCloseTo(
    0.66666
  );
  expect(Computation.parseWith(cpb("1+2/((3-4)+5)"), NumberUOL.parse)?.compute(UnitOfLength.Centimeter)).toBeCloseTo(
    1.5
