...
import { onDownload, onDownloadAs, onDropFile, onExportImage, onNew, onOpen, onSave, onSaveAs } from "./core/InputOutput";
...
const Root = observer(() => {
  ...
  useCustomHotkeys("Shift+Mod+E", onExportImage, ENABLE_ON_ALL_INPUT_FIELDS);
