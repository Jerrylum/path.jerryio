...
import { NumberRange, ValidateEditableNumberRange, EditableNumberRange, ValidateNumber } from "@core/Util";
...
// observable class
export class PathConfigImpl implements LemLibPathConfig {
  @Exclude()
