...
chassis.printCoords();
chassis.moveToBoom( 24, 24, 133.6, 0.7095089932546322,5);
chassis.moveToBoom( 24, -24, -116.82300000000001, 0.7511567373713952,5);
chassis.moveToBoom( -24, -24, -17.854025751516758, -2.49265999405679,5);
chassis.moveToBoom( -24, 24, 20.008747952175142, 0.8558511879438432,5);
