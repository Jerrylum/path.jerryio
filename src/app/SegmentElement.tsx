    ...
    <>
      {/* ALGO: Do not calculate points here */}
      {
        props.segment.controls.length === 4 ? (
          <>
            {props.segment.controls[1].visible ? <SegmentControlVisualLineElement start={props.segment.controls[0]} end={props.segment.controls[1]} cc={props.cc} /> : null}
            {props.segment.controls[2].visible ? <SegmentControlVisualLineElement start={props.segment.controls[2]} end={props.segment.controls[3]} cc={props.cc} /> : null}
          </>
        ) : null
      }
